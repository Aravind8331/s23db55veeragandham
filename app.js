...
async function recreateDB() {
  ...
  let instance1 = new electronics({ type: "Fan", Manufacturer: "Havels", cost: 50 });
  let instance2 = new electronics({ type: "Light", Manufacturer: "Philips", cost: 30 });  
  let instance3 = new electronics({ type: "Television", Manufacturer: "LG", cost: 150 });
